...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        unemployment_chart_data = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemployment_chart_data,
                x='Vehicle_Type',
                y='Automobile_Sales',
        ...
        total_ad_expenditure = yearly_data.groupby('Vehicle_Type')['Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                total_ad_expenditure,
                values='Expenditure',
                names='Vehicle_Type',
